    ...
    <section id="services" style={{ ...bgStyle, position: 'relative' }} className="w-full py-24 md:py-32">
      ...
      <div className="max-w-6xl mx-auto px-6" style={cs}>
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-5" style={{ color: styles.headingColor, fontFamily: 'Syne, sans-serif' }}>{c.heading}</h2>
          {c.subheading && <p className="text-base leading-relaxed" style={{ color: styles.mutedColor }}>{c.subheading}</p>}
        </div>
